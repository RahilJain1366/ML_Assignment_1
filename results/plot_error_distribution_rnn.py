...
with open('RNN_results/error_distribution.json') as f:
    errors = json.load(f)
...
# Save the plot
plt.savefig("RNN_results/error_bar_graph.png")
plt.show()

print("Error bar graph saved to RNN_results/error_bar_graph.png")
